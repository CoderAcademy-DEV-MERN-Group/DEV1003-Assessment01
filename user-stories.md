...
<!-- DESIGNS user stories appropriate to a web development project to a professional level (10%).

Valid, sensible and clear user stories for:

[ ] AT LEAST THREE different users or personas

[ ] AT LEAST THREE different reasons or justifications

[ ] AT LEAST FOUR different wants, features or functionalities. -->
...
<!-- [User Stories Template](https://www.atlassian.com/agile/project-management/user-stories)

"As a [persona]":
- Who are we building this for?

“Wants to”:
- Here we’re describing their intent - not the features they use.
...
Professional structure: All user stories follow As a [persona], I want [goal], so that [benefit].

User Story Pattern: As a [type of user], I want [some goal], so that [some reason]. -->
